...
export const DocumentArrowUpIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12V3.5a1.5 1.5 0 00-3 0V12m0 0l-1.5-1.5m1.5 1.5l1.5-1.5" />
  </svg>
);
...
export const PillIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path d="M10 2a8 8 0 100 16 8 8 0 000-16zM5.08 8.056A4.002 4.002 0 0110 4.5V5a3 3 0 00-3.92 2.944.056.056 0 00.056.056H5.08zM10 15.5V15a3 3 0 003.92-2.944.056.056 0 00-.056-.056h1.056a4.002 4.002 0 01-4.92 3.444z" />
    </svg>
);
...
export const LockClosedIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 11h14a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2z" />
    </svg>
);

// Flag Icons
export const UKFlagIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
...
export const EgyptFlagIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600" className={className}>
        ...
        <g transform="translate(450,300)">
            <circle r="50" fill="#C09300" stroke="#000" strokeWidth="2"/>
            <path d="M0,-40 L15,-20 L0,-25 L-15,-20 Z" fill="#C09300" stroke="#000" strokeWidth="1.5"/>
            <ellipse cx="0" cy="-10" rx="8" ry="12" fill="#C09300" stroke="#000" strokeWidth="1.5"/>
            <path d="M-20,0 Q-10,15 0,10 Q10,15 20,0" fill="none" stroke="#000" strokeWidth="2"/>
        </g>
    </svg>
);